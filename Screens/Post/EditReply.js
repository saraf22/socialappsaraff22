...
export class EditReply extends Component {
  constructor(props) {
    ...
    this.state = {
      reply: this.props.navigation.state.params.item.data().reply
    };
  }
  update(item) {
    firebase
      ...
      .collection("comments")
      .doc(this.props.navigation.state.params.commentId)
      .collection("replies")
      .doc(item.id)
      .update({
      ...
      <View style={styles.containerMain}>
        ...
        <View style={styles.container}>
          ...
          <TouchableHighlight
            ...
            onPress={() => this.update(this.props.navigation.state.params.item)}
          >
